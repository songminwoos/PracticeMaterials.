...
*   └ ComputeArea.java 파일 생성 && 소스 코드 작성
*   └ ComputeAreaWithConsoleInput.java 파일 생성 && 소스 코드 작성
*   └ ComputeAverage.java 파일 생성 && 소스 코드 작성

# 2021년 10월 27일 실습 일지
* Ch02_Variables\src\p02\datatypes\basic Folder Create
*   └ VariableEx.java 파일 생성 && 소스 코드 작성
*   └ VariableEx2.java 파일 생성 && 소스 코드 작성
*   └ VariableEx3.java 파일 생성 && 소스 코드 작성
*   └ BooleanEx.java 파일 생성 && 소스 코드 작성
*   └ ByteEx.java 파일 생성 && 소스 코드 작성
*   └ CharEx.java 파일 생성 && 소스 코드 작성
*   └ FloatDoubleEx.java 파일 생성 && 소스 코드 작성
*   └ IntEx.java 파일 생성 && 소스 코드 작성
*   └ LongEx.java 파일 생성 && 소스 코드 작성
* Ch02_Variables\src\p02\datatypes\casting Folder Create
*   └ CastingEx.java 파일 생성 && 소스 코드 작성
*   └ CastingEx2.java 파일 생성 && 소스 코드 작성
*   └ CastingEx3.java 파일 생성 && 소스 코드 작성
* Ch02_Variables\src\p02\datatypes\promotion Foider Create
*   └ PromotionEx.java 파일 생성 && 소스 코드 작성
# 2021년 10월 28일 실습 일지
* Ch02_Variables\src\p01\escape_seq Folder Create
*   └ EscapeSequenceEx.java 파일 생성 && 소스 코드 작성
* Ch03.Operators\src\p01\baisc Folder Create
*   └ ArithmeticOperatorEx.java 파일 생성 && 소스 코드 작성
*   └ AssignmentOperatorEx.java 파일 생성 && 소스 코드 작성
*   └ LogicalOperatorEx.java 파일 생성 && 소스 코드 작성
*   └ OperatorPrecedenceEx.java 파일 생성 && 소스 코드 작성
*   └ RelationalOperatorEx.java 파일 생성 && 소스 코드 작성
*   └ TernaryOperatorEx.java 파일 생성 && 소스 코드 작성
*   └ UnaryOperatorEx.java 파일 생성 && 소스 코드 작성
* Ch03_Operators\src\p03\inc_dec Folder Create
*   └ IncrementOperatorEx.java  파일 생성 && 소스 코드 작성

# 2021년 10월 29일 실습 일지
* Ch02_Variables\src\p03\local_variable_scope Folder Create
     └ LocalVariableScopeEx.java 파일 생성 && 소스 코드 작성
* Ch02_Variables\src\p04\type_max_min_value Folder Create
    └ ByteTypeMinMaxCheckEx.java 파일 생성 && 소스 코드 작성
    └ TypeMaxMinValueEx.java 파일 생성 && 소스 코드 작성
* Ch03_Operators\src\p02\inc_dec Folder Edit
*   └ DecrementOperatorEx.java 파일 생성 && 소스 코드 작성
* Ch03_Operators\src\p03\realnumber_problem Folder Create
*   └ RealNumberWrongUseEx.java 파일 생성 && 소스 코드 작성
*   └ RealNumberCorrectUseEx.java 파일 생성 && 소스 코드 작성
* Ch03_Operators\src\p04\nan_infinity Folder Create
*    └ InfinityAndNaNCheckEx.java 파일 생성 && 소스 코드 작성
*  Ch03_Operators\src\p05\practice Folder Create
*   └ AdditionQuiz.java 파일 생성 && 소스 코드 작성
*   └ DisplayTime.java 파일 생성 && 소스 코드 작성
*   └ FahrenheitToCelsius.java 파일 생성 && 소스 코드 작성
*   └ ShowCurrentTime.java 파일 생성 && 소스 코드 작성
...
*   └ Circle.java 파일 생성 && 소스 코드 작성
*   └ TestCircle.java 파일 생성 && 소스 코드 작성
* Ch09_Class\src\p01\basic2 Folder Create
*   └ Circle.java 파일 생성 && 소스 코드 작성
*   └ TestCircle.java 파일 생성 && 소스 코드 작성
* Ch09_Class\src\p01\basic3 Folder Create
*   └ Book.java 파일 생성 && 소스 코드 작성
*   └ BookEx.java 파일 생성 && 소스 코드 작성
* Ch09_Class\src\p01\basic4 Folder Create
*   └ TV.java 파일 생성 && 소스 코드 작성
*   └ TestTV.java 파일 생성 && 소스 코드 작성
* Ch09_Class\src\p01\basic5 Folder Create
*   └ Student.java 파일 생성 && 소스 코드 작성
*   └ TestStudent.java 파일 생성 && 소스 코드 작성
...
*   └ Computer.java 파일 생성 && 소스 코드 작성
*   └ ComputerEx.java 파일 생성 && 소스 코드 작성
* Ch09_Class\src\p04\method_overloading Folder Create
*   └ Calculator.java 파일 생성 && 소스 코드 작성
*   └ CalculatorEx.java 파일 생성 && 소스 코드 작성

# 2021년 11월 11일 실습 일지
* Ch09_Class\src\p05.java_library Folder Create
*  └ DateEx.java 파일 생성 && 소스 코드 작성
*  └ TestPoint2D.java 파일 생성 && 소스 코드 작성
* Ch09_Class\src\p06.static_variable Folder Create
*  └ Circle.java 파일 생성 && 소스 코드 작성
*  └ Korean.java 파일 생성 && 소스 코드 작성
*  └ TestCircleWithStaticFields.java 파일 생성 && 소스 코드 작성
...
*  └ Circle.java 파일 생성 && 소스 코드 작성
*  └ TestPassObject.java 파일 생성 && 소스 코드 작성
*  └ TestPassObject2.java 파일 생성 && 소스 코드 작성
*  └ TestPassObject3.java 파일 생성 && 소스 코드 작성
* Ch09_Class\src\p09.pass_array_of_object Folder Create
*  └ Circle.java 파일 생성 && 소스 코드 작성
*  └ TotalArea.java 파일 생성 && 소스 코드 작성
...
*  └ Earth.java 파일 생성 && 소스 코드 작성
*  └ EarthEx.java 파일 생성 && 소스 코드 작성

# 2021년 11월 15일 실습 일지
*Ch09_Class\p10\singleton_usage Folder Create
*  └  Singleton.java 파일 생성 && 소스 코드 작성
*  └ SingletonEx.java 파일 생성 && 소스 코드 작성
...
* └ InterfaceA.java 파일 생성 및 소스 코드 작성
