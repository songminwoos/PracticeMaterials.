...
// System.nanoTime 메소드 : 현재 시간을 nano second (1/1,000,000,000) 단위로 환산한 long type의 정수값 리턴
// 1. 사용 용도 : 프로그램내부적으로 실행 소요 시간 계산
// System.currentTimeMills 메소드 : 현재 시간을 mili second (1/1000) 단위로 환산한 long type의 정수값 리턴  
